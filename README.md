...
**Datasets_2** Overview of grid attributes in South America with downscaled distribution data from floras included (Dataset 2)

**species_list.csv** The taxonomic status and range size for each aquatic macrophytes.
